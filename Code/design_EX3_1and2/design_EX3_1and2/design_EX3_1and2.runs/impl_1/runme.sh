...
HD_PWD='C:/Users/OmenLaptop/Vivado/design_EX3_1and2/design_EX3_1and2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_EX3_1and2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_EX3_1and2.tcl -notrace
