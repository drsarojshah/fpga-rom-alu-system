...
#
# Script generated by Vivado on Wed Apr 17 12:32:30 -0400 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_IP_design3_Q3.sh
...
#
# Usage        : design_IP_design3_Q3.sh
#                design_IP_design3_Q3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_IP_design3_Q3.sh [-reset_run]
#                design_IP_design3_Q3.sh [-reset_log]
#                design_IP_design3_Q3.sh [-help]
#
...
# script info
echo -e "design_IP_design3_Q3.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_IP_design3_Q3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_IP_design3_Q3 xil_defaultlib.design_IP_design3_Q3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_IP_design3_Q3 -key {Behavioral:sim_1:Functional:design_IP_design3_Q3} -tclbatch cmd.tcl -protoinst "protoinst_files/design_IP_design3_Q3.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_IP_design3_Q3.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_IP_design3_Q3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_IP_design3_Q3.sh [-help]\n\
Usage: design_IP_design3_Q3.sh [-step]\n\
Usage: design_IP_design3_Q3.sh [-lib_map_path]\n\
Usage: design_IP_design3_Q3.sh [-reset_run]\n\
Usage: design_IP_design3_Q3.sh [-reset_log]\n\
Usage: design_IP_design3_Q3.sh [-keep_index]\n\
Usage: design_IP_design3_Q3.sh [-noclean_files]\n\n\
