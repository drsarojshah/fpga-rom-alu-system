...
#
# Script generated by Vivado on Fri Apr 19 16:03:12 -0400 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot design_IP_design3_Q3 xil_defaultlib.design_IP_design3_Q3 -log elaborate.log
}
